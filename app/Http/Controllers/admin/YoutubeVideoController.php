...
class YoutubeVideoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.youtube-videos.list',compact('title','breadcrumbHtml'));
    }
    ...
    public function changeStatus($id){
        $video = YouTubeVideo::find(base64_decode($id));
        $video->status = ($video->status == true) ? false : true;
        $video->save();
        return response()->json([
    ...
    public function changeTrending($id){
        $video = YouTubeVideo::find(base64_decode($id));
        $video->trending = ($video->trending == true) ? false : true;
        $video->save();
        return response()->json([
            'message' => 'Status changed successfully!',
            'status'  => true,
